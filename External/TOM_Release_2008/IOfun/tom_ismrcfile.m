...
%TOM_ISMRCFILE checks for mrc format
%
%   tom_ismrcfile(em_name)
%
%PARAMETERS
%
%  INPUT
...
%  
%  OUTPUT
%   out		        1 for mrc format
%                   0 no mrc format
%
%EXAMPLE
%  
% 
% out=tom_ismrcfile('20S_core_1.6nm.mrc');
% out
%
%
%REFERENCES
...
%TOM_AMIRA_CREATEISOSURFACE checks if the file is a MRC-file format
%
%   i=tom_ismrcfile(filename)
%
%DESCRIPTION
%Check if filename exists and if filename contains a 1024 byte header and a 
