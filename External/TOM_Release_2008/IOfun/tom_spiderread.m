...
%EXAMPLE
%   
% im=tom_spiderread('20S_core_1.6nm.spi');
...
%read in full volume
fseek(fid,Data.Header.Spider.labbyt,'bof');
Data.Value = fread(fid,Data.Header.Spider.nslice .* Data.Header.Spider.nrow .* Data.Header.Spider.nsam,'float');
Data.Value = reshape(single(Data.Value), Data.Header.Spider.nsam, Data.Header.Spider.nrow, Data.Header.Spider.nslice);
