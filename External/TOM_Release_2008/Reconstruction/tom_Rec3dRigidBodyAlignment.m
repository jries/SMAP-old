function [Matrixmark, psi, sigma, x, y, z]  = tom_Rec3dRigidBodyAlignment...
(Matrixmark,irefmark,imintilt,r,imdim,ProtocolMode)
%TOM_REC3DRIGIDBODYALIGNMENT is a module of TOM_REC3DGUI.
%
%   [Matrixmark, psi, sigma, x, y, z]  = tom_Rec3dRigidBodyAlignment...
%   (Matrixmark,irefmark,imintilt,r,imdim,ProtocolMode)
%
%   It calculates a rigidbody alignment from measured marker positions.
%
%PARAMETERS
%
%  INPUT
%   Matrixmark[]        Matrix of dimension (10, no. of images, no. of
%                       markers)
%   irefmark            Reference marker (default: marker 1)
%   imintilt            reference projection (default: Projection with
%                       minimum tilt)
%   r[3]                3D coordinates assigned to marker irefmark
%                       (default: r = [x(imintilt), y(imintilt), imdim/2 + 1])
...
%   z[no. of markers]   ...
%
%   performs alignment if markerpoints are clicked
%   analog to EM system - routine tilt.f
%
%EXAMPLE
%
%REFERENCES
