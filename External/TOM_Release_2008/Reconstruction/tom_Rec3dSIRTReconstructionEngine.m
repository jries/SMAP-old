...
%
%SEE ALSO
%   TOM_REC3DALIGNMENTENGINE   TOM_VOL2PROJ   TOM_BACKPROJ3D
%
%   01/01/07 ME
%
...
for k=1:NumOfProj
    ...
    if strcmp(Pathlength, 'ones') == 1
         PathlengthProj = tom_vol2proj(PathlengthVolume, [ProjDir(k) Tiltangles(k)]);
...
for i=1:Iterations
    ...
    for k=1:NumOfProj
         ...
         cProj = tom_vol2proj(cRec, [ProjDir(k) Tiltangles(k)]);
