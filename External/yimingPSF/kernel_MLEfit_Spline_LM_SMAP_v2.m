function [P] =  kernel_MLEfit_Spline_LM_SMAP_v2(d_data,coeff,sz,iterations)
...
for tx = 1:Nfits
    ...
    %     off = (spline_xsize-(2*(sz-1)))/2;
    off = floor(((spline_xsize+1)-2*sz)/2);
    ...
    for ii = 0:sz-1
        for jj = 0:sz-1
            ...
            [newDudt,model] =  kernel_DerivativeSpline_v2(2*ii+xstart+off,2*jj+ystart+off,zstart,spline_xsize,spline_ysize,spline_zsize,delta_f,delta_dxf,delta_dyf,delta_dzf,coeff,newTheta);
