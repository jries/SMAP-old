function cdata = f_iconRead(filename,guessalpha)
% f_ICONREAD read an image file and convert it to CData for a HG icon.
%
% CDATA=f_ICONREAD(FILENAME)
...
%
% CDATA=f_ICONREAD(FILENAME, FALSE)
