classdef ManualTransform<recgui.DialogProcessor
    methods
        function obj=ManualTransform(varargin)        
...
%             addlistener(obj.locData,'synchronizeGui',@obj.synchronizeGui);
    ...
    methods(Static)
        function info=info(obj)
            info.name='ManualTransform';
            info.class=@ManualTransform;
            info.tag='ManualTransform';
%             obj.info=info;
        end
