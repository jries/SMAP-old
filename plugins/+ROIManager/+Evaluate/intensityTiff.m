    ...
    methods
        ...
        function out=run(obj,p)
            ...
            rangey=(pr(2)-sfit:pr(2)+sfit)*pixcam(2);
                ...
                startim=dgaussforfit([mcentral 0 0 0 0 0],X,Y,[pos(1),pos(2), 250, p.mind]);
...
%                 if fitp(4)<pos(2), fitp(4)=min(fitp(4),pos(2)-p.mind); else fitp(4)=max(fitp(4),pos(2)+p.mind); end
                ...
                fitp3=triplegaussfit(coim,rangex,rangey,startp2,fixp);  
                ...
                fitim3=triplegaussforfit(fitp3,X,Y,fixp);
