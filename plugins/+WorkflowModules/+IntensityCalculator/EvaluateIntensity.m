...
%         end
        function makeGui(obj)
            ...
            huitable=uitable('Units','pixels','Position',[fw,1.5*fh,fw,5.5*fh],'Parent',obj.handle,'FontSize',obj.guiPar.fontsize);
            ...
            for k=1:length(obj.evaluators)
                ...
                hpanel=uipanel('Parent',obj.handle,'Units','pixels','Position',[2*fw,1.5*fh,2*fw,5.5*fh],'FontSize',fs,'Visible','off');
