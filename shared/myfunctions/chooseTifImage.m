...
slider=uicontrol('style','slider','Units','normalized','Position',[0.02,0.02,0.5,.05],'Callback',@slidercallback,'SliderStep',[1 10]/numberOfFrames,'Max',numberOfFrames);
